...
@section('content')
    ...
    @endif
    <div class="title">
        <h2>Inspiratie voor ontwerp & uitstraling</h2>
        <p class='lead'></p>
    </div>
    <form action="Ontwerp/store" method="post">
        ...
        <div class="head3">
            <h4 style="margin-bottom: 25px" class="kunHead">Kun je 3 voorbeelden geven van websites die inhoudelijk vergeljikbaar zijn?</h4>
            <div class="form-group">
                <label for="comment">Website 1</label>
                <textarea  class="form-control" rows="2" id="comment" name="website1"></textarea>
            </div>
            <hr>
            <div class="form-group">
                <label  for="comment">Website 2</label>
                <textarea  class="form-control" rows="2" id="comment" name="website2"></textarea>
            </div>
            <hr>
            <div class="form-group">
                <label  for="comment">Website 3</label>
                <textarea  class="form-control" rows="2" id="comment" name="website3"></textarea>
            </div>
            <hr>
        </div>

        <div class="head4">
            <h4 style="margin-bottom: 25px">Geef 3 voorbeelden van websites die je mooi of goed vind (wat betreft het design, structuur van de inhoud, of het logo) en beschrijf wat je er welke digen je mooi en welke dingen je niet mooi aan de sites vindt:</h4>
            <div class="form-group">
                <label for="comment">Website 1</label>
                <textarea  class="form-control" rows="2" id="comment" name="mooiWebsite1"></textarea>
            </div>
            <hr>
            <div class="form-group">
                <label  for="comment">Website 2</label>
                <textarea  class="form-control" rows="2" id="comment" name="mooiWebsite2"></textarea>
            </div>
            <hr>
            <div class="form-group">
                <label for="comment">Website 3</label>
                <textarea  class="form-control" rows="2" id="comment" name="mooiWebsite3"></textarea>
            </div>
            <hr>
        </div>
        ...
        <div class="col-md-6 col-md-offset-5">
            <section class="jump">
                ...
                <a href="/bedrijf"  style="color: #fff;background: #000; padding: 7px; width: 110px; border: none; font-size: 19px;" href= "#" class="btn btn-default text-center"> < vorige </a>
